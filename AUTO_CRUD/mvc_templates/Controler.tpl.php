...
class @@@uControlerName@@@ extends BaseController
{
	...
	public function getAll()
	{
		...
		foreach ($result as $key => $value) {
			...
			$ops .= '<a class="dropdown-item text-info" onClick="save('. $value->@@@primaryKey@@@ .')"><i class="fa-solid fa-pen-to-square"></i>   ' .  lang("App.edit")  . '</a>';
			$ops .= '<a class="dropdown-item text-orange" ><i class="fa-solid fa-copy"></i>   ' .  lang("App.copy")  . '</a>';
			$ops .= '<div class="dropdown-divider"></div>';
			$ops .= '<a class="dropdown-item text-danger" onClick="remove('. $value->@@@primaryKey@@@ .')"><i class="fa-solid fa-trash"></i>   ' .  lang("App.delete")  . '</a>';
			$ops .= '</div></div>';
